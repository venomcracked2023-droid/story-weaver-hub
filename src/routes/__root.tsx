...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Lcucumber — Đọc Webtoon online" },
      { name: "description", content: "Lcucumber — đọc webtoon online cuộn dọc miễn phí, cập nhật chương mới mỗi ngày, giao diện nhẹ và mượt trên mọi thiết bị." },
      ...
      { property: "og:title", content: "Lcucumber — Đọc Webtoon online" },
