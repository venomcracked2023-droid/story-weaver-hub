    ...
    <header className="sticky top-0 z-40 border-b border-border/60 bg-background/70 backdrop-blur-xl supports-[backdrop-filter]:bg-background/50">
      <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-4">
        ...
        <nav className="flex items-center gap-0.5 text-sm">
          ...
          {isAdmin && (
            <Link to="/admin-applications" rel="nofollow" className={navClass} activeProps={{ className: activeClass }}>
          ...
          {user && !isContributor && (
            <Link to="/apply" rel="nofollow" className={navClass} activeProps={{ className: activeClass }}>
